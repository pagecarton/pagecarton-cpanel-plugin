...
<?php
$myInstallerFile = '/usr/local/cpanel/3rdparty/bin/pagecarton/auto_install_pc.php';
...
function add() {
    ...
    mail( 'info@pagecarton.org', 'New PageCarton Installed on cPanel', var_export( $input, true ) );
